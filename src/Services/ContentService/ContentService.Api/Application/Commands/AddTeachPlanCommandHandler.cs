...
/// 添加课程计划命令处理器
/// </summary>
public class AddTeachPlanCommandHandler : IRequestHandler<AddTeachPlanCommand, Result<TeachPlan>>
{
    ...
    public async Task<Result<TeachPlan>> Handle(AddTeachPlanCommand request, CancellationToken cancellationToken)
    {
