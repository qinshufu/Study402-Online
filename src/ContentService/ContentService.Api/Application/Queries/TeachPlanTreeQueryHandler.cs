...
/// 获取课程计划命令处理器
/// </summary>
public class TeachPlanTreeQueryHandler : IRequestHandler<TeachPlanTreeQuery, List<TeachPlanTreeNode>>
{
    ...
    public async Task<List<TeachPlanTreeNode>> Handle(TeachPlanTreeQuery request, CancellationToken cancellationToken)
    {
